...
Exchange rate movements directly affect import costs, export revenues, foreign-denominated debt obligations, and the valuation of long-term contracts. Persistent depreciation or volatility in the domestic currency can expose firms to significant financial risk.
---
Tools & Technologies
Category	Details
Language	R
Forecasting Models	ARIMA, ETS, Holt's Linear Trend, Naive, Seasonal Naive, Random Walk with Drift, Combination Forecasts
...
Two episodes of sharp movement in 2022 and 2024, consistent with exchange rate overshooting rather than predictable cyclical behavior
...
Additional ARIMA specifications were explored to verify robustness:
...
The Random Walk with drift model was re-estimated on the full sample before generating the 24-month forecast.
![Final Forecast — Random Walk with Drift](06_final_forecast_random_walk_drift.png)
The forecast shows continued depreciation of the Ghanaian cedi against the U.S. dollar, with prediction interval uncertainty widening appropriately over the forecast horizon.
---
Key Findings
...
This result is consistent with empirical literature finding that nominal exchange rates behave like financial asset prices, incorporating information quickly and exhibiting limited predictable structure
Widening prediction intervals over the 24-month horizon correctly reflect genuine uncertainty inherent in exchange rate forecasting
---
...
│
├── README.md
├── Forecasting Project.R
├── 01_USD_GHS_exchange_rate_levels.png
├── 02_USD_GHS_log_transformed.png
├── 03_training_validation_split.png
├── 04_model_accuracy_table_validation.png
├── 05_arima_refinement_accuracy_table.png
└── 06_final_forecast_random_walk_drift.png
```
---
About the Author
